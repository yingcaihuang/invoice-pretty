...
async def download_file(
    ...
    Args:
        ...
        inline: Whether to display inline (for preview) or as attachment (for download)
        session: Session ID from query parameter (for iframe access)
    ...
    try:
        ...
        # Get session ID from middleware or query parameter (for iframe access)
        session_id = session or request.state.session_id
